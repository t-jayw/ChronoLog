    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            Container(
              child: ShareModalContent(timepiece: timepiece, repaintBoundaryKey: repaintBoundaryKey),
            ),
            SizedBox(height: 8),
            PrimaryButton(
              child: Text('Share', style: TextStyle(color: Theme.of(context).colorScheme.inversePrimary)),
