...
class TimingMeasurementsContainer extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final timingMeasurements =
        ref.watch(timingMeasurementsListProvider(timingRunId));
    ...
    return timingMeasurements.isNotEmpty
            ...
            itemBuilder: (context, index) {
              ...
              return Dismissible(
                ...
                onDismissed: (direction) {
                  ref
                      .read(
                          timingMeasurementsListProvider(timingRunId).notifier)
                ...
                child: Column(
                  children: [
                    TimingMeasurementItem(timingMeasurement: timingMeasurement),
                  ],
                ),
              );
        ...
        : Container(
            ...
            child: const Text('No timing measurements available.'),
          );
  }
}
