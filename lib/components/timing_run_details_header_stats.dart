...
class TimingRunDetailHeaderStats extends ConsumerStatefulWidget {
  ...
  @override
  _TimingRunDetailHeaderStatsState createState() =>
      _TimingRunDetailHeaderStatsState();
}

class _TimingRunDetailHeaderStatsState
    extends ConsumerState<TimingRunDetailHeaderStats> {
